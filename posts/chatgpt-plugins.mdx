...
It's going to be quicker and easier to deploy an API with a ChatGPT Plugin as the interface than it is to write a web or mobile app. By partnering with Zapier, this connects ChatGPT Plugin with another 5,000 apps.
